...
In other words, matrix factorization is truly the stuff that sets real data scientists apart from the data alchemists, data phrenologists, data astrologers, and other kinds of data charlatans.
...
Sidenote: this style of reasoning, called "drawing actionable insights," is the cornerstone of the data-scientific method, and it distinguishes modern data science from earlier, barbaric data pseudosciences.
