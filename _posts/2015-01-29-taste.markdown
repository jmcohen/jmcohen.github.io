...
Fortunately, thanks to collaborative filtering, Amazon will pick up on the trend and make the right recommendation. The sale will get made, and verybody will win: Jeff Bezos will become richer, the baby won't get [left behind](http://en.wikipedia.org/wiki/Mozart_effect), and the Amazon programmer who wrote the feature will [quit and join another company](http://www.glassdoor.com/GD/Reviews/Amazon-com-Reviews-E6036_P2.htm?filter.jobTitleFTS=Software).
