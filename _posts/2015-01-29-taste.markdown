...
In other words, matrix factorization is the real deal.  It's the stuff that separates the true data scientists from the charlatans like data alchemists, data phrenologists, and data astrologers.
